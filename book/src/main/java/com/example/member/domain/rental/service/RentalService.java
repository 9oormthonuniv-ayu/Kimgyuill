package com.example.member.domain.rental.service;
...
import com.example.member.domain.book.repository.BookRepository;
import com.example.member.domain.rental.repository.RentalRepository;
import com.example.member.domain.user.domain.MemberEntity;
import com.example.member.domain.user.repository.MemberRepository;
